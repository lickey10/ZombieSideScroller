...
namespace Endless2DTerrain
{
    public class PrefabPool
    {
        ...
        public GameObject Add(GameObject prefabToClone, Vector3 position, float angle, float yRotation, string type, bool matchGroundAngle)
        {
            ...
            if (prefabToAdd == null){
                ...
                if (angle != 0 && matchGroundAngle){
                     prefab.transform.localEulerAngles = new Vector3(0, yRotation, angle);
                }
                ...
                if (angle != 0 && matchGroundAngle){
                     prefabToAdd.Prefab.transform.localEulerAngles = new Vector3(0, yRotation, angle);
                }
                prefabToAdd.IsSpawned =true;
                prefabToAdd.Prefab.SetActive(true);
            }
